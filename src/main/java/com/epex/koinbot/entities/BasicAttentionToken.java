...
@Document(collection = "basic_attention_token_portfolio")
public class BasicAttentionToken extends CurrencyPortfolio {

    public BasicAttentionToken(CurrencyPortfolio c) {
